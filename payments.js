...
// --- Prezzi (in centesimi) ---
const PRICES = {
  base: parseInt(process.env.PRICE_BASE_CENTS || '1990', 10), // €19,90
  pro: parseInt(process.env.PRICE_PRO_CENTS || '3490', 10),   // €34,90
};
const LABELS = {
  base: 'photodin Base — 40 foto professionali',
  pro: 'photodin Pro — 60 foto professionali',
};
const priceCents = (pkg) => PRICES[pkg] || PRICES.base;
const label = (pkg) => LABELS[pkg] || LABELS.base;
